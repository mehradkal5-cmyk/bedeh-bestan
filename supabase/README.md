...
1. Create a Supabase project and enable Email OTP / magic-link sign-in. Set the allowed redirect URL to the production origin and, for development, `http://127.0.0.1:4173`.
